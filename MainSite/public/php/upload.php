...
<main>
    <section class="page-header">
        ...
        <p>Upload a photo and optional story  or just drop files into <code>public/gallery/</code>.</p>
    </section>
    ...
    <section class="section">
        ...
        <div class="upload-help">
            ...
            <ul>
                <li>Copy images directly into <code>public/gallery/</code>  they appear automatically.</li>
